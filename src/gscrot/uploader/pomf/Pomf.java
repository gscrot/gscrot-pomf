...
public class Pomf {
	...
	public static String upload(byte[] b, String ext, String mime) throws Exception {
		...
		HttpPost httppost = new HttpPost("https://pomf.se/upload.php?output=gyazo");
		
		MultipartEntityBuilder reqEntity = MultipartEntityBuilder.create();
		reqEntity.setMode(HttpMultipartMode.BROWSER_COMPATIBLE).addBinaryBody("files[]", b, ContentType.create(mime), "image." + ext);
